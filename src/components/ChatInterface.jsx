...
function ChatInterface({ problem, solution, isModal = false }) {
  ...
  return (
    <div className={isModal ? "h-full flex flex-col p-4" : "mt-4 border-t border-gray-200 dark:border-gray-700 pt-4"}>
      {!isModal && (
          ...
          <div className="flex flex-wrap gap-2">
            {suggestedQuestions.map((question, index) => (
              <button
                ...
                className="px-3 py-1.5 text-xs sm:text-sm bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/50 transition-colors border border-purple-200 dark:border-purple-800"
              >
                {question}
              </button>
            ))}
          ...
          <div className="flex flex-wrap gap-1.5">
            {suggestedQuestions.map((question, index) => (
              <button
                key={index}
                onClick={() => handleSuggestedQuestion(question)}
                className="px-2.5 py-1 text-xs bg-white dark:bg-gray-700 text-purple-700 dark:text-purple-300 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/30 transition-colors border border-purple-200 dark:border-purple-600"
              >
                {question}
              </button>
            ))}
      ...
      {/* Zone de chat */}
      <div className={`${isModal ? 'flex-1 flex flex-col min-h-0' : 'bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 flex flex-col min-h-0'}`}>
